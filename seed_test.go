...
func Test_seed_retrieve(t *testing.T) {
	...
	tests := []struct {
		...
		{"base", s, []IP{IP{"127.0.0.1", "80"}, IP{"192.168.0.1", "8088"}, IP{"10.12.13.14", "8110"}}},
		{"bad", s2, []IP{IP{"192.168.0.1", "8088"}, IP{"10.12.13.14", "8110"}}},
		{"mainnet", s3, []IP{
			IP{"52.17.183.121", "8108"},
			IP{"52.17.153.126", "8108"},
			IP{"52.19.117.149", "8108"},
			IP{"52.18.72.212", "8108"},
			IP{"52.19.44.249", "8108"},
			IP{"52.214.189.110", "8108"},
			IP{"34.249.228.82", "8108"},
			IP{"34.248.202.6", "8108"},
			IP{"52.19.181.120", "8108"},
			IP{"34.248.6.133", "8108"},
		}},
	}
